...
class AudioRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun updateDBStatus(objectPath: String): Response<UpdateDBStateResponseDTO> {
        return service.updateDBStatus(getAccessTokenWithPrefix(), objectPath)
    }
}